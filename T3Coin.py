...
def mine():
    ...
    while True:
        ...
        h_label.config(text=f"Высота: {height}")
        log.see(tk.END)

root = tk.Tk()
root.title("T3Coin Wallet")
root.geometry("1000x680")
root.configure(bg="black")

tk.Label(root, text="T 3 C O I N", font=("Courier",40,"bold"), fg="#00FF00", bg="black").pack(pady=30)
tk.Label(root, text="Первый троичный блокчейн", font=("Courier",16), fg="#00FF00", bg="black").pack()
...
e = tk.Entry(frame, width=60, font=("Courier",11), bg="#001100", fg="#00FF00", justify="center")
e.insert(0, "T3:Т10ТТ1Т01ТТ101Т0Т1ТТ10Т1Т01")
e.config(state="readonly")
e.pack(pady=10)

bal_label = tk.Label(frame, text="333333 T3C", font=("Courier",28,"bold"), fg="#00FF00", bg="black")
bal_label.pack(pady=15)
h_label = tk.Label(frame, text="Высота: 0", font=("Courier",14), fg="#00FF00", bg="black")
h_label.pack()
